...
function buildArtistCard(a) {
  ...
  const spotifyBtn = a.spotifyUrl
    ? `<a class="artist-spotify-btn" href="${escHtml(a.spotifyUrl)}" target="_blank" rel="noopener" onclick="event.stopPropagation()">
  ...
  const links = [];
  if (a.instagramUrl) links.push(`<a class="artist-social-link" href="${escHtml(a.instagramUrl)}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="Instagram">
  ...
  if (a.youtubeUrl) links.push(`<a class="artist-social-link" href="${escHtml(a.youtubeUrl)}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="YouTube">
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.4a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"/></svg>
  </a>`);

  return `
    <article class="artist-card" data-id="${escHtml(a.id)}" style="cursor:pointer;">
      ...
      <div class="artist-card-open-hint">Profilə bax →</div>
    </article>
  `;
}
